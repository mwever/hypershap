...
from constants import ABLATION_GAME, DS_TUNABILITY_GAME, TUNABILITY_GAME
from pre_compute_games import _print_game_info
from utils import setup_game, GAME_STORAGE_DIR, _get_game_name
...
if __name__ == '__main__':
    ...
    database_cfg_file = "exp_conf/database_credentials.yml"

    if args.benchmark == "jahs":
        if args.game == ABLATION_GAME:
            experimenter = PyExperimenter(experiment_configuration_file_path="exp_conf/jahs-experimentsetup_ablation.yml", database_credential_file_path=database_cfg_file)
        elif args.game == DS_TUNABILITY_GAME:
            experimenter = PyExperimenter(experiment_configuration_file_path="exp_conf/jahs-experimentsetup_ds_tunability.yml", database_credential_file_path=database_cfg_file)
        else:
        ...
        if args.game == ABLATION_GAME:
            experimenter = PyExperimenter(experiment_configuration_file_path="exp_conf/pd1-experimentsetup_ablation.yml", database_credential_file_path=database_cfg_file)
        elif args.game == DS_TUNABILITY_GAME:
            experimenter = PyExperimenter(experiment_configuration_file_path="exp_conf/pd1-experimentsetup_ds_tunability.yml", database_credential_file_path=database_cfg_file)
        else:
            print("Benchmark ", args.benchmark, " and game ", args.game, " is not a valid combination.")
            exit(1)
        ...
        if args.game == ABLATION_GAME:
            experimenter = PyExperimenter(experiment_configuration_file_path="exp_conf/yahpogym-experimentsetup_ablation.yml", database_credential_file_path=database_cfg_file)
        elif args.game == DS_TUNABILITY_GAME:
            experimenter = PyExperimenter(experiment_configuration_file_path="exp_conf/yahpogym-experimentsetup_ds_tunability.yml", database_credential_file_path=database_cfg_file)
        elif args.game == TUNABILITY_GAME:
            experimenter = PyExperimenter(experiment_configuration_file_path="exp_conf/yahpogym-experimentsetup_tunability.yml", database_credential_file_path=database_cfg_file)
        else:
            print("Benchmark ", args.benchmark, " and game ", args.game, " is not a valid combination.")
            exit(1)
