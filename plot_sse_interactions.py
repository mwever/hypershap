...
if __name__ == "__main__":
    ...
    budgets = [25, 50, 100, 200, 400, 800, 1600, 3200] # [25, 50, 100, 200]
    for budget in budgets:
        hpo_game = shapiq.Game(path_to_values="continuous_smac_analysis_test_"+scenario+"_" + str(dataset) + "_" + str(budget) + ".npz", verbose=False, normalize=True)
        parameter_names = ['batch_size', 'learning_rate', 'max_dropout', 'max_units', 'momentum', 'num_layers', 'weight_decay']
        ...
        try:
            plot_interactions(
                game=hpo_game, player_names=parameter_names, game_name="Continuous-SMAC-Analysis-" +scenario+ "-" + str(dataset) + "-" + str(budget), save=True, show=True
            )
        except:
            pass
