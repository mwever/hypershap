...
def plot_and_save_interactions(file_name: str, benchmark: str) -> None:
    ...
    fsii.plot_si_graph(show=False, size_factor=3.0, feature_names=parameters, pos=pos)
    plt.tight_layout()
    ...
    mi.plot_si_graph(show=False, size_factor=3.0, feature_names=parameters, pos=pos)
    plt.tight_layout()
    plt.savefig(save_path)
    print(f"Saved SI graph to {save_path}")
    plt.show()
